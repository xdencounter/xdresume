package com.ray.base.common.page;

import com.ray.base.common.Constants;
import com.ray.base.common.bean.Entity;
import com.ray.base.common.util.DateJsonValueProcessor;
import com.ray.base.common.util.ReflectUtil;
import com.ray.base.common.util.StringUtil;
	...
	public static String toJson4Entity(Entity entity, boolean booleanObject,
		...
		if (booleanObject){
			if (StringUtil.isBlank(columns)){
				...
				//return model.toJson(columns);
			}
		}
		if (StringUtil.isBlank(columns)){
			//return model.toJsonAsArray();
		}else{
			//return model.toJsonAsArray(columns);
		}
		return null;
	}
